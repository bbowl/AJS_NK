...
test.beforeEach(async ({ page }) => {
  ...
  await page.locator('//*[contains(@id, "user-name")]').fill('standard_user');
  await page.locator('//*[contains(@id, "password")]').fill('secret_sauce');
  await page.locator('//*[contains(@id, "login-button")]').click();
});
...
test('test2_add_2_items_to_shopping_cart', async ({ page }) => {
  ...
  await page.locator('//button[contains(@data-test,"add-to-cart")]').nth(0).click();
